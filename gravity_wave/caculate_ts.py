...
class Draw(TS):
    ...
    def draw_bar(self, ts):
        ...
        ax.legend(fontsize=10, edgecolor='white', loc='upper right', ncol=2)
        ...
        fig.savefig('/mnt/zfm_18T/fengxiang/HeNan/gravity_wave/figure/picture_rain/rain_new/ETS_score_24h.png')
