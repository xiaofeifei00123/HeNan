...
class Draw(Vp):
    def __init__(self,pic_dic) -> None:
        ...
        self.fig_name = os.path.join(self.pic_path, pic_dic['time']+pic_dic['domain'])
...
def main():
    # flnm='/mnt/zfm_18T/fengxiang/HeNan/Data/GWD/gwd3/wrfout_d03_2021-07-20_01:00:00'
    f_path = '/mnt/zfm_18T/fengxiang/HeNan/Data/GWD/gwd3/'
    domain_list = ['d01', 'd02', 'd03']
    time_range = pd.date_range('2021-07-19 1300', '2021-07-21 0000', freq='1H')
    for t in time_range:
        for d in domain_list:
            ...
            print(pic_dic['domain']+pic_dic['time'])
