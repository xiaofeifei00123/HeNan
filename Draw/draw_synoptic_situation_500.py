...
class DataShow():
    ...
    def draw_barbas(self,u,v):
        ...
        self.ax.barbs(x, y, u.values*2.5, v.values*2.5,length=6,pivot='middle',
    ...
    def draw_quiver(self,u,v):
        ...
        qk = ax.quiverkey(Q, X=0.7, Y=0.15, U=30, label=r'$30\ m/s$', labelpos='E',coordinates='figure')   # 设置参考风矢
...
def test():
    ...
    # ds
    # dd = ds.sel(time='2021-07-20 1700')
    # ddd = dd['temperature'].sel(pressure=500)-273.15
    # ddd.max()
    kw = {'pre':500, 'select_time':tt}
    dr = Draw()
