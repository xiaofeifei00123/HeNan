...
def draw(time, period, power, sst, sig95, coi, ax2, fig):
...
if __name__ == '__main__':
    ...
    im, ticks = draw(time, period, power, sst, sig95, coi, ax1, fig)
    ...
    fig.savefig('/mnt/zfm_18T/fengxiang/HeNan/Draw/picture_lunwen/wavelet.png')