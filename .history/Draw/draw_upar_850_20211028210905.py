...
def add_ticks(ax,):
    ...
    ax.set_yticks(np.arange(32, 36 + 1, 5))
    ax.set_xticks(np.arange(110, 116 + 1, 5))
...
def draw_model_once():
    ...
    dic_model = {'model': '4nest', 'flnm':path_out}
    ...
    ### 北京时
    # ttt = pd.DatetimeIndex(['2021-07-19 08', '2021-07-20 08'])
    ttt = pd.DatetimeIndex(['2021-07-19 08', '2021-07-20 17'])
