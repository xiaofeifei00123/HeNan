...
i = 0
for t in tt:
    rr = dc.isel(time=t)  # 时间t时刻的累计降水
    rain = rr-r
    r = rr
    dds_list.append(rain)
    i += 1
...
# dds_concate = xr.concat(dds_list, )
xr.concat(dds_list, pd.Index(tt, name='ttt'))
