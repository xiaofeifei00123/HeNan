...
class Draw(object):
    ...
    def create_map(self, ax):
        ...
        henan = cfeat.ShapelyFeature(
            Reader(self.path_henan).geometries(),
            proj,
            edgecolor='k',
            facecolor='none')
        ...
        ax.add_feature(provinces, linewidth=2, zorder=2)
        ax.add_feature(henan, linewidth=2, zorder=2)
...
def draw_one():
    ...
    # flnm = '/mnt/zfm_18T/fengxiang/HeNan/Data/HighResolution2/YSU_rain_1km_hight_hgt.nc'
    ...
    t = '1900'
    picture_dic = {'date':'2021-07-20 00-12', 'type':'NSSL', 'initial_time':t}
    dr.draw_single(da, picture_dic)
