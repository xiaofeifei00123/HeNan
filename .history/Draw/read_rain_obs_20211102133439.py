...
# da.max()
# rain = da.sel(time='2021-07-20 08')
# rain
# quick_contourf(rain)
...
class RainGrid():
    ...
    def rain_station2grid(self, da):
        ...
        for i in tt:
            ...
            hour_grid = inverse_distance_to_grid(da.lon.values, da.lat.values, da_hour.values, lon_gridmesh, lat_gridmesh, r=0.25, min_neighbors=2)
