...
da_rain = da_rain_all.sel(time=slice('2021-07-20 00', '2021-07-20 20'))  # 24小时逐小时降水
...
class Draw(object):
    ...
    def draw_single(self, da, date):
        ...
        color_ticks=[0.1, 5, 15.0, 30, 70, 140, 250.0]#雨量等级
        ...
        path = '/mnt/zfm_18T/fengxiang/HeNan/Draw/picture_rain/'

        fig_name = path+'OBS'+date
