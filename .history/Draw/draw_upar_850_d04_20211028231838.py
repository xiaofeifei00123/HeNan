...
### 测试
# %%
flnm_wrf = '/mnt/zfm_18T/fengxiang/HeNan/Data/high_resolution_high_hgt_upar_d04.nc'
ds = xr.open_dataset(flnm_wrf)
da4 = ds['q'].sel(time='2021-07-20 00').sel(pressure=850)
ds
# %%
lon = ds.lon
lat = ds.lat
...
# lon
dx, dy = ca.lat_lon_grid_deltas(lon, lat)
# %%
ds.lon
# dx
# dy.max()
