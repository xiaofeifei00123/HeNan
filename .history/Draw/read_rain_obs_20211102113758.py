...
from baobao import quick_draw as qd

da = xr.open_dataarray('/mnt/zfm_18T/fengxiang/HeNan/Data/OBS/rain_grid.nc')
da
rain = da.sel(time='2021-07-20 00')
# rain
qd.quick_contourf(rain)
...
class RainGrid():
    ...
    def rain_station2grid(self, da):
        ...
        for i in tt:
            ...
            hour_grid = inverse_distance_to_grid(da.lon.values, da.lat.values, da_hour.values, lon_gridmesh, lat_gridmesh, r=0.5, min_neighbors=1)
