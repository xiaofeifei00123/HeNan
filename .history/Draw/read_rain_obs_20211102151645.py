...
ax = fig.add_axes([0.1, 0.1, 0.8, 0.8], projection=ccrs.LambertConformal(central_latitude=34, central_longitude=))
...
ax.tricontourf(rain.lon, rain.lat, rain, cmap=cmaps.precip3_16lev)
# plt.scatter()
