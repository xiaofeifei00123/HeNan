...
class Sounding():
    ...
    def __init__(self,
                ...
                path_main = '/mnt/zfm_18T/fengxiang/HeNan/Data/LES/'
    ...
    def sounding_main(self):
        ...
        fl_list = os.popen('ls {}/wrfout_d01*'.format(self.path_wrfout))  # wrfout文件的path
        fl_list = fl_list.read().split()

        print("1.合并不同时次数据")
        # dds = self.sounding_1station_mp(fl_list)
        dds = self.sounding_1station(fl_list)
        # print("2. 开始计算诊断变量")
